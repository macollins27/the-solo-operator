...
1. Read `.Codex/skills/pedagogy/SKILL.md` in full. Do not trust your memory of prior sessions. Re-read.
...
| `.Codex/skills/pedagogy/SKILL.md` | THE teaching protocol. Read at session start every time. Auto-loaded by Codex as a project skill. |
